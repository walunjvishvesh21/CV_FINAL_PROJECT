...
SYNTH_DIR = os.path.join(ROOT_DIR, "synthetic_train_config4")
OUTPUT_DIR = "outputs"
MODEL_DIR = "models"
...
model_path = os.path.join(MODEL_DIR, "synth_aug_resnet50_gtsrb_best.pth")
...
with open(os.path.join(OUTPUT_DIR, "synth_aug_classification_report.txt"), "w", encoding="utf-8") as f:
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Synth + Aug Loss Curve")
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "synth_aug_loss_curve.png"))
plt.close()
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Synth + Aug Accuracy Curve")
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "synth_aug_accuracy_curve.png"))
plt.close()
...
plt.title("Synth + Aug Confusion Matrix")
plt.colorbar()
...
plt.tight_layout()
plt.savefig(os.path.join(OUTPUT_DIR, "synth_aug_confusion_matrix.png"))
plt.close()
...
pd.DataFrame({
    ...
    os.path.join(OUTPUT_DIR, "synth_aug_test_metrics.csv"),
    index=False
)

print("Saved synth_aug_classification_report.txt")
print("Saved synth_aug_loss_curve.png")
print("Saved synth_aug_accuracy_curve.png")
print("Saved synth_aug_confusion_matrix.png")
print("Saved synth_aug_training_history.csv")
print("Saved synth_aug_test_metrics.csv")
print("\nSynth + Aug run completed successfully.")